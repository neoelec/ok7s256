/* ========================================================================== */
/*	     Xtest14_4.c : RS-232C Communication by DBGU Polling(2)	      */
/* ========================================================================== */
...
unsigned int DBGU_check_RXRDY(void)		/* check RXRDY of DBGU */
{
  return *AT91C_DBGU_CSR & 0x0001;		// if RXRDY=1, return 1
}						// if not, return 0
  ...
  *AT91C_DBGU_CR = 0x00000150;			// TX, RX enable
  ...
  while(1)
    { switch(Key_input())                       // key input
      ...
      if(DBGU_check_RXRDY() == 1)
        { LCD_data(DBGU_RX_char());		// display a received character
