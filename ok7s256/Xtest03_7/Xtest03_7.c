/* ========================================================================== */
/*         Xtest03_7.c : Check SLCK, MAINCK, PLLCK Clock Frequency(1)         */
/* ========================================================================== */
...
int main(void)
{
  ...
  while (1) {
    ...
    Beep();                                    // check PLLCK
    LCD_string(0xC0, "PLLCK=192.000MHz");
    AT91F_PMC_EnablePCK(AT91C_BASE_PMC, 1, AT91C_PMC_PRES_CLK | AT91C_PMC_CSS_PLL_CLK);
    Delay_ms(5000);
  }
}
