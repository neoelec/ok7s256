/* ========================================================================== */
/*	    Xtest14_9.c : RS-232C Communication by USART0 Polling(2)	      */
/* ========================================================================== */
...
unsigned int USART0_check_RXRDY(void)		/* check RXRDY of USART0 */
{
  return *AT91C_US0_CSR & 0x0001;		// if RXRDY=1, return 1
}						// if not, return 0
  ...
  *AT91C_US0_CR = 0x00000150;			// TX, RX enable
  ...
  while(1)
    { switch(Key_input())                       // key input
      ...
      if(USART0_check_RXRDY() == 1)
        { LCD_data(USART0_RX_char());		// display a received character
